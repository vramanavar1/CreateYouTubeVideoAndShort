...
_ENV_KEYS = [
    ...
    # A real endpoint here would send test images to a live Foundry deployment.
    "YTSHORT_ART_DIRECTOR",
    "YTSHORT_FOUNDRY_ENDPOINT",
    "YTSHORT_FOUNDRY_DEPLOYMENT",
    "YTSHORT_FOUNDRY_API_VERSION",
    "YTSHORT_THUMBNAIL_HOOK_VARIANTS",
]
